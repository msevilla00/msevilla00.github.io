...
var style_OSM_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(7,137,20,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2}),
...
function update() {
    ...
    var features = lyr_OSM_1.getSource().getFeatures();
